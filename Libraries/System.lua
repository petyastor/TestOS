...
function system.updateDesktop()
	...
	local TestOSContextMenu = desktopMenu:addContextMenuItem("TestOS", 0x000000)
	TestOSContextMenu:addItem(localization.aboutSystem).onTouch = function()
		...
		local lines = {
			...
			"Developers:",
			" ",
			"Petya Storozhuk, vk.com/petyastor",
			" ",
			"Source: github.com/IgorTimofeev/MineOS",
		}
	...
	TestOSContextMenu:addItem(localization.updates).onTouch = function()
		system.execute(paths.system.applicationAppMarket, "updates")
	end

	TestOSContextMenu:addSeparator()

	TestOSContextMenu:addItem(localization.logout).onTouch = function()
		system.authorize()
	end

	TestOSContextMenu:addItem(localization.reboot).onTouch = function()
		require("Network").broadcastComputerState(false)
		computer.shutdown(true)
	end

	TestOSContextMenu:addItem(localization.shutdown).onTouch = function()
		require("Network").broadcastComputerState(false)
		computer.shutdown()
	end
