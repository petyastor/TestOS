...
local repositoryURL = "https://raw.githubusercontent.com/petyastor/TestOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/TestOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "TestOS")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("TestOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("TestOS HDD")
	end
	...
	EEPROMProxy.setLabel("TestOS EFI")
